...
(function () {
  ...
  function boot() {
    ...
    // 1) UI existe?
    // Aceita UI.start (legado) ou UI.init/UI.go (novo)
    const hasInitGo = NS.UI && typeof NS.UI.init === 'function' && typeof NS.UI.go === 'function';
    const hasStart = NS.UI && typeof NS.UI.start === 'function';
    if (!hasInitGo && !hasStart) {
